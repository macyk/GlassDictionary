...
BUCKET_ID = '28e197a6-fcdc-4a04-a1a7-a6a8c08dfeec' 

DATA_KEY_SECRET_TOKEN = '7tMBGNmaxV0ppfQQHLltHS3gmTXZyC8qsJ0taZXj'

# with KA auth, both http and https are possible
QUERY_ENDPOINT= 'https://query-api.kooaba.com/v4/query'

QUERY_KEY_SECRET_TOKEN = 'isbjrsuRTUTzWyawwxReBYKVxADWwzilX2XTtSvX' 
QUERY_KEY_ID='db568bad-9070-4a00-894a-56296f48d91e' ## only needed for KA authentication
...
def query_example():
    ...
    try:
       result =client.query('../images/coffee.jpg', 'KA')
